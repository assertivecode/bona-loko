...
| `eng-seo-implementation` | `engineering` | [engineering/seo-implementation/SKILL.md](./engineering/seo-implementation/SKILL.md) | seo, search engine optimization, meta tags, allowed tags, keywords, sitemap, sitemap.xml, frontmatter tags, og tags |
...
| `meta-skill-builder` | `meta (agent)` | [skill-builder/SKILL.md](./skill-builder/SKILL.md) | create skill, new skill, add skill, scaffold skill, register skill, update catalog |
...
### 🌐 Bundle D: Content Authoring & SEO Publication
*Use when writing or publishing articles, or updating web pages for search discoverability.*
- `eng-seo-implementation` (Ensure metadata, tag registry mirroring, and sitemap accuracy)
- `tech-nuxt-development` (Ensure Nuxt page rendering and in-component translation dictionary)
