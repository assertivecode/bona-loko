...
- [ ] Copy and interaction models avoid comparisons to other apps ([.agents/rules/no-platform-comparisons.md](../../rules/no-platform-comparisons.md)).
- [ ] Features and UI feedback embody the 7 Core Values ([.agents/rules/platform-core-values.md](../../rules/platform-core-values.md)), prioritizing Humility (unpretentious self-knowledge) before demanding Integrity (congruent action).
